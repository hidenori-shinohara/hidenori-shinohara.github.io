...
1. Let $u_1$ be the first standard basis vector $(1, 0, \cdots, 0)$.

1. Randomly pick $A \in \mathbb{Z}^{n \times n}_q$.
1. Randomly pick $s \in \mathbb{Z}^{n}_q$.
1. Sample $e$ from $N^n$.
1. Set $b = (A \cdot s + pe) \mod q$.
1. Return $(A, b)$.
...
1. Let $b_1 = (b \cdot r_1 + m_1u_1 + pe_1) \pmod q$.
1. Return $c_1 = (a_1, b_1)$.

# Decrypt

$((b_1 - a_1 \cdot s) \pmod q) \pmod p$ is $m_1$.
